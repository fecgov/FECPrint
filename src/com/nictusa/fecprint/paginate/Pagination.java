package com.nictusa.fecprint.paginate;
...
public class Pagination {
	...
	{
		System.out
				.println("java -Xms512m -Xmx1024m -classpath <FECPrint jar path> com.nictusa.fecprint.paginate.Pagination imgnofile=<lockfile pathname> outfile=<image number out file pathname> <datafile pathname>");
		System.exit(1);
	}
